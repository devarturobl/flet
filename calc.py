...
class CalculatorApp(ft.Container):
    def init(self):
        self.reset()
        self.width = 350
        self.bgcolor = ft.Colors.BLACK_87
    ...
    def button_clicked(self, e):
        ...
        # La f antes de las comillas en Python significa "Formatted string literal" (o más comúnmente llamada f-string). 
        # Las f-strings permiten incluir expresiones dentro de cadenas de texto, las cuales se evalúan en tiempo de ejecución y se insertan en la cadena resultante.
